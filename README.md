...
Part of the spoofed speeches is from public datasets and the others are generated using commercial TTS and open-source TTS/VC algorithms. 

We collected two public deepfake speech datasets, including a Chinese dataset Wavefake and a English dataset FAD. The two datasets collect some speech samples generated by the same synthesis algorithms, including HiFiGAN, Multiband-MelGAN and PWG. 
